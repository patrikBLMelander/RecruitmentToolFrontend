        ...
        <Router> 
            <div>
                <Routes>
                    ...
                    <Route path="/login" exect element= {<Login activeAdmin={activeAdmin} adminLoggedIn={adminLoggedIn} setAdminLoggedIn={setAdminLoggedIn} candidateLoggedIn={candidateLoggedIn} setCandidateLoggedIn={setCandidateLoggedIn} jobOfferings={jobOfferings} activeJob={activeJob} setActiveJob={setActiveJob}candidateState={candidateState} setActiveCandidate={setActiveCandidate}/>}/>
                </Routes>
            </div>
        </Router>
    )
