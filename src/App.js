        ...
        <Router> 
            <div>
                <Routes>
                    ...
                    <Route path="/admin/settings" element= {<Settings setCandidateState={setCandidateState} candidateState={candidateState}  jobOfferings={jobOfferings}  activeJob={activeJob} adminLoggedIn={adminLoggedIn} setAdminLoggedIn={setAdminLoggedIn} candidateLoggedIn={candidateLoggedIn} setCandidateLoggedIn={setCandidateLoggedIn}/>}/> 
